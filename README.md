...
**部署地址：** http://115.190.224.6/api.php
...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v2.2.0** | 2026-06 | 修复收藏功能页面空白 Bug；新增 GitHub Actions 自动构建 Release（Tag 触发）；开启 R8 混淆缩减 + 资源缩减（APK 缩减至 2.6MB）；代码仓库历史清理优化；README 全面重写为中文文档 |
| v2.1.0 | — | 帮助页重写（完整技术文档）、Release 构建（R8 + 缩减，APK 2.1MB） |
| v2.0.0 | — | 设置/缓存/历史收藏/双 Tab 导航 |
| v1.x | — | 基础功能迭代 |
| v1.0.0 | — | 初始版本 |
